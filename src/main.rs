...
struct EnvPruned{
    ...
    patients: Vec<PatientPruned>,

    _travel_jump_size: i32,
    travel_matrix: Vec<f32>,
}
...
fn main() {
    ...
    println!("{:?}",pruned_set.travel_matrix.len());
    // for n in 0..9{
